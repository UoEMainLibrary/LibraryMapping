    ...
    (function (factory, window) {
        ...
        var LocateControl = L.Control.extend({
            ...
            setView: function () {
                if (this._isOutsideMapBounds()) {
                    ...
                    if (this.options.keepCurrentZoomLevel) {
                        ...
                        var _newPoint = fromLatLngToVectorPoint(this._event.latitude, this._event.longitude);
                        ...
                        this._map.panTo(map.unproject([m.x, m.y], map.getMaxZoom() - 1));
            ...
            _drawMarker: function () {
                ...
                var _newPoint = fromLatLngToVectorPoint(latlng.lat, latlng.lng);
                var newPoint = reflectYaxis(_bl.subtract(_newPoint));
                ...
                if (this.options.drawMarker) {
                    ...
                    if (!this._marker) {
                        this._marker = new this.options.markerClass(map.unproject([m.x, m.y], map.getMaxZoom() - 1), mStyle).addTo(this._layer);
                    } else {
                        this._marker.setLatLng(map.unproject([m.x, m.y], map.getMaxZoom() - 1)).setStyle(mStyle);
                    }
                }
