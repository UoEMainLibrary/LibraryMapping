...
function addAccessors($scope) {
    ...
    var addShape = function(shapeName) {
        ...
        fabric.loadSVGFromURL('http://fabricjs.com/assets/' + shapeName + '.svg', function(objects, options) {
...
//        loadedObject.toObject = function() {
//          return $.extend(loadedObject, {name: "asd"} )
//        };

            console.log(loadedObject.toJSON());
